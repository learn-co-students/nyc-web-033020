...
- Why? 
  - First we taught Ruby what a "thing" is 
    - Using Ruby Objects, behaviors are very similar to hashes with the exception of being able to hold both methods and variables (multiple attributes/characteristics)
  - Represent the relationships between "things" 

  Cat can have an Owner

  Ruby knows what a Cat is
  Ruby knows what an Owner is

  But Ruby does not know how the two are related (if there is a relation)
