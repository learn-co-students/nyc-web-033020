...
#### Authorization
- can't create a goat unless logged in
- Can't delete a goat unless logged in
- Create a Review/Like without having to select yourself
- Can only see the logged_in users show page (aka your own profile page)
